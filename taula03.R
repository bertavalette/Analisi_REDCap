...
taula_biv <-table1(~ region + sex + months_old + month_of_birth + ethnic + kindergarten + breast_binary + space_living + smokers_home | nirse_binary, data = no_na_nirse, overall=F, extra.col=list(`p-value`=pvalue))
