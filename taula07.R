...
RC_edit_descriptiu$vrs_result <- factor(RC_3$vrs_result, levels = c(1,2,3), labels = c("positive", "negative","unknown/not valid"))
RC_edit_descriptiu$antigenic_performed_SARS_CoV_2 <- factor(RC_3$antigenic_performed, levels = c(0,1), labels = c("no","yes"))
RC_edit_descriptiu$antigenic_result_SARS_CoV_2 <- factor(RC_3$antigenic_result, levels = c(1,2,3), labels = c("positive", "negative","unknown/not valid"))
...
RC_edit_descriptiu$flu_a_result <- factor(RC_3$flu_a_result, levels = c(1,2,3), labels = c("positive", "negative","unknown/not valid"))
RC_edit_descriptiu$flu_b_result <- factor(RC_3$flu_b_result, levels = c(1,2,3), labels = c("positive", "negative","unknown/not valid"))
...
taula_biv <-table1(~ region + vrs_result + antigenic_performed_SARS_CoV_2 + antigenic_result_SARS_CoV_2 + othervirus_performed + adeno_result + flu_a_result 
                   ...
                   + urg_viruses___13 + urg_viruses___14 + urg_viruses___15 + adm_hospital + picu_adm + final_diagnosis_code | nirse_binary, data = no_na_nirse, overall=F, extra.col=list(`p-value`=pvalue))
