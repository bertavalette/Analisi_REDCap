#Tercera taula (bivariada per adm nirse, demogràfica)
...
taula_biv <-table1(~ region + sex + months_old + month_of_birth + seasonal_catchup + ethnic + kindergarten + breast_binary + space_living + smokers_home | nirse_binary, data = RC_RSV_descriptiu, overall=F, extra.col=list(`p-value`=pvalue))
taula_biv_seasonal <-table1(~ region + sex + months_old + month_of_birth + ethnic + kindergarten + breast_binary + space_living + smokers_home | nirse_binary, data = RC_RSV_seasonal, overall=F, extra.col=list(`p-value`=pvalue))
taula_uv_catchup <-table1(~ region + sex + months_old + month_of_birth + ethnic + kindergarten + breast_binary + space_living + smokers_home | nirse_binary, data = RC_RSV_catchup, overall=F, extra.col=list(`p-value`=pvalue))
