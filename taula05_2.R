...
taula_uv <- table1(~ seasonal_catchup + nirse_binary + vrs_result + antigenic_performed_SARS_CoV_2 + antigenic_result_SARS_CoV_2 + othervirus_performed + adeno_result + flu_a_result 
                   ...
                   + urg_viruses___13 + urg_viruses___14 + urg_viruses___15 + adm_hospital + picu_adm + final_diagnosis_code, data = RC_edit_descriptiu)

taula_uv_seasonal <-table1(~ nirse_binary + vrs_result + antigenic_performed_SARS_CoV_2 + antigenic_result_SARS_CoV_2 + othervirus_performed + adeno_result + flu_a_result 
                           + flu_b_result + emergency_dep_binary + urg_viruses___1 + urg_viruses___2 + urg_viruses___3 + urg_viruses___4 
                           + urg_viruses___5 + urg_viruses___6 + urg_viruses___7 + urg_viruses___8 + urg_viruses___9 + urg_viruses___10 + urg_viruses___11 + urg_viruses___12 
                           + urg_viruses___13 + urg_viruses___14 + urg_viruses___15 + adm_hospital + picu_adm + final_diagnosis_code, data = RC_edit_seasonal)

taula_uv_catchup <-table1(~ nirse_binary + vrs_result + antigenic_performed_SARS_CoV_2 + antigenic_result_SARS_CoV_2 + othervirus_performed + adeno_result + flu_a_result 
                          + flu_b_result + emergency_dep_binary + urg_viruses___1 + urg_viruses___2 + urg_viruses___3 + urg_viruses___4 
                          + urg_viruses___5 + urg_viruses___6 + urg_viruses___7 + urg_viruses___8 + urg_viruses___9 + urg_viruses___10 + urg_viruses___11 + urg_viruses___12 
