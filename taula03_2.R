...
taula_biv <- table1(~ region + sex + months_old + ethnic + kindergarten + breast_binary + space_living + smokers_home + sister_home_binary | nirse_binary, 
                    data = no_na_nirse, overall = FALSE, extra.col = list(`P-value` = pvalue))
