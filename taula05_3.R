#Primera taula (univariada, outcomes)
#Separant seasonals i catchups pero en mateixa taula

#Crear còpia
RC_edit_descriptiu <- RC_3

RC_edit_descriptiu$seasonal_catchup <- factor(RC_edit_descriptiu$seasonal_catchup, levels = c("seasonal","catchup"), labels = c("Seasonal","Catch-up"))
RC_edit_descriptiu$region <- factor(RC_edit_descriptiu$region, levels = c(0,1), labels = c("Catalonia", "Italy"))
...
RC_edit_descriptiu$antigenic_performed <- factor(RC_3$antigenic_performed, levels = c(0,1), labels = c("no","yes"))
colnames(RC_edit_descriptiu)[colnames(RC_edit_descriptiu) == "antigenic_performed"] <- "antigenic_performed_SARS_CoV_2"
RC_edit_descriptiu$antigenic_result <- factor(RC_3$antigenic_result, levels = c(1,2), labels = c("positive", "negative"))
colnames(RC_edit_descriptiu)[colnames(RC_edit_descriptiu) == "antigenic_result"] <- "antigenic_result_SARS_CoV_2"
...
#Netejar cohort catchups
RC_edit_catalan <- subset(RC_edit_descriptiu, region == "Catalonia")
RC_edit_catchup <- subset(RC_edit_catalan, seasonal_catchup == "Catch-up")
RC_edit_seasonal <- subset(RC_edit_descriptiu, seasonal_catchup == "Seasonal")
RC_edit_seasonal_catchup <- rbind(RC_edit_seasonal, RC_edit_catchup)

RC_edit_seasonal_catchup$urg_viruses___1 <- factor(RC_edit_seasonal_catchup$urg_viruses___1, levels = c("no", "yes"))
label(RC_edit_seasonal_catchup$urg_viruses___1) <- "urg_viruses_SARS-CoV-2"
RC_edit_seasonal_catchup$urg_viruses___2 <- factor(RC_edit_seasonal_catchup$urg_viruses___2, levels = c("no", "yes"))
label(RC_edit_seasonal_catchup$urg_viruses___2) <- "urg_viruses_influenza A H1N1pdm09"
RC_edit_seasonal_catchup$urg_viruses___3 <- factor(RC_edit_seasonal_catchup$urg_viruses___3, levels = c("no", "yes"))
label(RC_edit_seasonal_catchup$urg_viruses___3) <- "urg_viruses_influenza A H3N2"
RC_edit_seasonal_catchup$urg_viruses___4 <- factor(RC_edit_seasonal_catchup$urg_viruses___4, levels = c("no", "yes"))
label(RC_edit_seasonal_catchup$urg_viruses___4) <- "urg_viruses_influenza B"
RC_edit_seasonal_catchup$urg_viruses___5 <- factor(RC_edit_seasonal_catchup$urg_viruses___5, levels = c("no", "yes"))
label(RC_edit_seasonal_catchup$urg_viruses___5) <- "urg_viruses_VRS-A"
RC_edit_seasonal_catchup$urg_viruses___6 <- factor(RC_edit_seasonal_catchup$urg_viruses___6, levels = c("no", "yes"))
label(RC_edit_seasonal_catchup$urg_viruses___6) <- "urg_viruses_VRS-B"
RC_edit_seasonal_catchup$urg_viruses___7 <- factor(RC_edit_seasonal_catchup$urg_viruses___7, levels = c("no", "yes"))
label(RC_edit_seasonal_catchup$urg_viruses___7) <- "urg_viruses_adenovirus"
RC_edit_seasonal_catchup$urg_viruses___8 <- factor(RC_edit_seasonal_catchup$urg_viruses___8, levels = c("no", "yes"))
label(RC_edit_seasonal_catchup$urg_viruses___8) <- "urg_viruses_human metapneumovirus"
RC_edit_seasonal_catchup$urg_viruses___9 <- factor(RC_edit_seasonal_catchup$urg_viruses___9, levels = c("no", "yes"))
label(RC_edit_seasonal_catchup$urg_viruses___9) <- "urg_viruses_parainfluenza 1,2,3,4"
RC_edit_seasonal_catchup$urg_viruses___10 <- factor(RC_edit_seasonal_catchup$urg_viruses___10, levels = c("no", "yes"))
label(RC_edit_seasonal_catchup$urg_viruses___10) <- "urg_viruses_bocavirus"
RC_edit_seasonal_catchup$urg_viruses___11 <- factor(RC_edit_seasonal_catchup$urg_viruses___11, levels = c("no", "yes"))
label(RC_edit_seasonal_catchup$urg_viruses___11) <- "urg_viruses_enterovirus"
RC_edit_seasonal_catchup$urg_viruses___12 <- factor(RC_edit_seasonal_catchup$urg_viruses___12, levels = c("no", "yes"))
label(RC_edit_seasonal_catchup$urg_viruses___12) <- "urg_viruses_rhinovirus"
RC_edit_seasonal_catchup$urg_viruses___13 <- factor(RC_edit_seasonal_catchup$urg_viruses___13, levels = c("no", "yes"))
label(RC_edit_seasonal_catchup$urg_viruses___13) <- "urg_viruses_other CoV"
RC_edit_seasonal_catchup$urg_viruses___14 <- factor(RC_edit_seasonal_catchup$urg_viruses___14, levels = c("no", "yes"))
label(RC_edit_seasonal_catchup$urg_viruses___14) <- "urg_viruses_other viruses"
RC_edit_seasonal_catchup$urg_viruses___15 <- factor(RC_edit_seasonal_catchup$urg_viruses___15, levels = c("no", "yes"))
label(RC_edit_seasonal_catchup$urg_viruses___15) <- "urg_viruses_none"


taula_biv <- table1(~ region + nirse_binary + vrs_result + antigenic_performed_SARS_CoV_2 + antigenic_result_SARS_CoV_2 + othervirus_performed + adeno_result + flu_a_result 
                   ...
                   + urg_viruses___13 + urg_viruses___14 + urg_viruses___15 + adm_hospital + picu_adm + final_diagnosis_code | seasonal_catchup, data = RC_edit_seasonal_catchup, overall=F, extra.col=list(`p-value`=pvalue))
