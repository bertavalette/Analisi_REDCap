...
taula_biv <-table1(~ vrs_result + antigenic_performed_SARS_CoV_2 + antigenic_result_SARS_CoV_2 
                   + othervirus_performed + adeno_result + flu_a_result 
                   ...
                   + urg_viruses___13 + urg_viruses___14 + urg_viruses___15 + adm_hospital 
                   + picu_adm + final_diagnosis_code | region*nirse_binary, data = no_na_nirse, overall=F, extra.col = list(`p-value (approx)`=pvalue,`p-value (fisher)`=pfisher))
