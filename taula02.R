...
taula_biv <-table1(~ sex + months_old + month_of_birth + ethnic + kindergarten + breast_binary + space_living + smokers_home + nirse_binary | region, data = RC_RSV_descriptiu, overall=F, extra.col=list(`p-value`=pvalue))
